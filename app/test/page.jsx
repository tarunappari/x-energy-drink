...
const page = () => {
  return (
     <main className="min-h-screen bg-gradient-to-b from-[#050608] via-[#081010] to-[#bfe8d4] text-slate-50">
      ...
      <header className="sticky top-0 z-40 backdrop-blur border-b border-white/10 bg-black/40">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
          ...
          <nav className="hidden gap-6 text-sm text-slate-200 md:flex">
            ...
            <a href="#ingredients" className="hover:text-emerald-300 transition">Ingredients</a>
            <a href="#science" className="hover:text-emerald-300 transition">Science</a>
        ...
        <div className="mx-auto flex max-w-6xl flex-col items-center gap-10 px-4 pb-20 pt-16 md:flex-row md:pb-28 md:pt-24">
          ...
          <div className="z-10 flex-1 space-y-6">
            ...
            <h1 className="text-balance text-4xl font-semibold leading-tight tracking-tight text-slate-50 sm:text-5xl lg:text-6xl">
              Calming energy
              <span className="block text-emerald-200">for the overactive mind.</span>
            </h1>

            <p className="max-w-xl text-sm text-slate-200 sm:text-base">
              X is a calming energy drink crafted with Ashwagandha, Bacopa, L-Theanine and more.
              It relaxes your mind while keeping you focused—without sugar, jitters or crash.
            </p>
            ...
            <div className="flex gap-6 pt-4 text-[11px] text-slate-300">
              ...
              <div>
                <p className="font-semibold text-slate-100">No Colour Added</p>
      ...
      {/* EXPERIENCE SECTION */}
      <section id="experience" className="border-y border-white/10 bg-black/40">
        <div className="mx-auto flex max-w-6xl flex-col gap-10 px-4 py-16 md:flex-row">
          <div className="flex-1 space-y-4">
            <h2 className="text-3xl font-semibold text-emerald-100">
              ...
              <span className="block text-slate-50">not a caffeine punch.</span>
            </h2>
            <p className="text-sm text-slate-300">
              X is designed for people whose minds never switch off—students, founders,
              gamers, night-shift warriors. A precise blend of adaptogens and amino acids
              helps you stay calm, focused and present.
            </p>
      ...
      {/* INGREDIENTS */}
      <section id="ingredients" className="bg-gradient-to-b from-black via-[#050b09] to-[#bfe8d4]">
        <div className="mx-auto max-w-6xl px-4 py-16">
          <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-xl text-sm text-slate-200">
                Every sip of X is built from clinically studied botanicals and amino acids,
                chosen to support calm focus without sugar spikes.
              </p>
            </div>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              ["L-Theanine", "Promotes relaxed alertness without drowsiness."],
              ["Bacopa Monnieri", "Supports memory, focus and cognitive function."],
              ["Centella Asiatica", "Traditionally used to support mental clarity."],
              ["Lemon Juice", "Fresh, zesty base that keeps it light and clean."],
              ["Himalayan Salt", "Electrolytes to keep you balanced and hydrated."],
              ["Stevia Rebaudiana", "Natural sweetness with zero sugar."],
              ["Citric Acid (Food Grade)", "Stabilises flavour and freshness."]
            ].map(([name, desc]) => (
              <div
                key={name}
      ...
      {/* SCIENCE / TIMELINE */}
      <section id="science" className="border-t border-white/10 bg-[#bfe8d4] text-slate-900">
        <div className="mx-auto max-w-6xl px-4 py-16">
          <div className="grid gap-10 md:grid-cols-[1.1fr,1fr]">
            <div>
              ...
              <div className="mt-8 space-y-6">
                {[
                  ["0 – 5 minutes", "Mint cools your senses, first wave of relaxation begins."],
                  ["10 – 15 minutes", "L-Theanine and botanicals turn down mental noise."],
                  ["20 – 30 minutes", "Calm, steady energy with deep focus and no restlessness."]
                ].map(([time, desc], i) => (
          ...
          <div className="grid gap-10 md:grid-cols-[1.1fr,1fr]">
            ...
            >
              ...
              <p className="mt-2 text-xs text-emerald-50/90">
                Drop your email and we&apos;ll let you know the moment X launches in your city.
              </p>
      ...
      <footer className="border-t border-slate-800 bg-black py-6 text-[11px] text-slate-400">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row">
          ...
          <div className="flex gap-4">
            <a href="#" className="hover:text-emerald-300">Ingredients</a>
