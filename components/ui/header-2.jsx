...
export function Header() {
  ...
  return (
    <header
      className={cn(
        "navbar sticky top-6 z-50 mx-auto w-full max-w-5xl border-b border-transparent md:rounded-md md:border md:transition-all md:ease-out",
        {
    ...
    >
      ...
      >
        ...
        <div className="hidden items-center gap-2 md:flex">
          ...
          <button className="buynowBtn relative inline-flex items-center justify-center px-8 py-2.5 overflow-hidden tracking-tighter text-white bg-gray-800 rounded-md group">
            {/* <span class="absolute w-0 h-0 transition-all duration-500 ease-out bg-[#60edad] rounded-full group-hover:w-56 group-hover:h-56"></span> */}
